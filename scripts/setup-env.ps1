# Comprehensive Python environment management for causaliq-research
# Usage: .\scripts\setup-env.ps1 [options]

param(
    [switch]$Install,           # Install causaliq-research package after creating environments
...
function Show-Help {
    ...
    Write-Host "  -Install         Create environments AND install causaliq-research package" -ForegroundColor White
    Write-Host "  -InstallOnly     Install causaliq-research package in existing environments" -ForegroundColor White
    Write-Host "  -Help            Show this help message" -ForegroundColor White
    Write-Host ""
    Write-Host "EXAMPLES:" -ForegroundColor Yellow
    Write-Host "  .\scripts\setup-env.ps1                    # Create environments only" -ForegroundColor Gray
    Write-Host "  .\scripts\setup-env.ps1 -Install           # Create + install causaliq-research" -ForegroundColor Gray
    Write-Host "  .\scripts\setup-env.ps1 -InstallOnly       # Install causaliq-research in existing envs" -ForegroundColor Gray
    Write-Host ""
...
function Install-InEnvironment {
    ...
    try {
        ...
        Write-Host "  Installing causaliq-research with dev dependencies..." -ForegroundColor Gray
...
if ($InstallOnly) {
    ...
    Write-Host "Installing causaliq-research in all environments..." -ForegroundColor Blue
    ...
    if ($Install) {
        Write-Host "(Will also install causaliq-research package)" -ForegroundColor Gray
    }
...
if (-not ($Install -or $InstallOnly)) {
    Write-Host "To install causaliq-research in all environments:" -ForegroundColor White
